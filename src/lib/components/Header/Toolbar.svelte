...
{#if !modalTextShowed}
  <ModalText
    ...
    text="Для добавления новой задачи Вам необходимо пройти процесс аутентификации. Но, как Вы, наверное, успели заметить, данная функция сейчас недоступна. Поэтому Ваша задача будет добавлена в хранилище и исчезнет после перезагрузки страницы или при выборе другого проекта =("
